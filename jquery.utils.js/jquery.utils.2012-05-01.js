...
$j(document).ready(function(){
    ...
    //add focus & blur states for zip code field on shopping cart 'calculate' shipping form
    $j(".SHOPPING-BAG #calculate .zipCode input[name='zipCode']").focus(function() {
	    if($j(this).val()=="Enter Zip Code"){
		    $j(this).val("");
	    }
    });

    $j(".SHOPPING-BAG #calculate .zipCode input[name='zipCode']").blur(function() {
	    if($j(this).val()==""){
