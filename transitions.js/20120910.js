...
YAHOO.ebauer.transitions = function() {
	...
	// onTransitionComplete will correct the position of the automatic iframe once the transition is finished, the iframe is used only in IE6
		...
		handleSuccess : function(o) {
			...
			jQuery('.sizeModule .tabs').tabs();// assign jquery tabs to sizeModule			
		...
		makeRequest : function(arg) {
			...
			if (url.match){
				...
				if(departId !=""){					
					...
					if (departId == "06" || departId == "08" || departId == "09" || departId == "10" || departId == "11" || departId == "17" || departId == "31" || departId == "45"){
						sections = "1";	
					...
					//tab 1 mens clothing
					if (departId == "01" || departId == "04" || departId == "15" || departId == "29" || departId == "33" || departId == "34" || departId == "38"){
						sections = "1";	
						selectedSizeChartTab = 0;
					...
					else if (departId == "03" || departId == "3"){
						sections = "1";	
					...
					//tab 2 Boys clothing
					else if (departId == "4001" || departId == "87"){
						sections = "1";	
						selectedSizeChartTab = 1;
						sizeChartName = "kids."+siteFlag+".html";	
						sizeChartUrl = sizeChartUrl + sizeChartName;
			...
			if ( sections != "" && sections != undefined && sections != "undefined"){
				sizeChartDetails(departId, sizeChartUrl);
				//var request = YAHOO.ebauer.utilities.asyncRequest('GET', sizeChartUrl, requestObject);
				//fb.start(sizeChartUrl, 'type:ajax height:505 width:996 autoFitHTML:true scrolling:no showOuterClose:true controlsPos:tr afterItemStart:updateTabs('+selectedSizeChartTab+')');
			} else {
